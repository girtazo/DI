...
def insertar(menuInsercion):
	campos = recogidaDatos(menuInsercion)
...
#crear handler
handlers = {
    "Mlistar": lambda(self) : listar(),
    "grabar": lambda(self) : insertar(xml)
}

#asignar handler
xml.asignarsenyales(handlers,True)
